...
- **Analysis date:** 2026-09-23 00:50 UTC
...
- Unique domains: 48
- IOCs extracted: 88
- Detection signals raised: 17 (15 active, 2 suppressed by allowlist)
- Correlated findings: 13
...
- **Severity:** Low &nbsp;|&nbsp; **Confidence:** Medium &nbsp;|&nbsp; **Risk score:** 35/100
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** 208.95.112.1
- **Domain(s):** ip-api.com
- **First/last seen:** 02:40:06 – 02:40:06 (2 occurrence(s))
- **Detection rule(s):** HTTP-004

**Why this matters:** 172.16.1.66 queried ip-api.com 1 time(s). HTTP activity was observed to ip-api.com. Local detection rule(s) HTTP-004 fired for this activity. Threat-intelligence assessment: SUSPICIOUS, WEAK_REPUTATION. Risk score 35/100 (Reputation 28, Behavior 2, Payload 0, Network context 5, Asset context 0 — asset role unknown).
...
- AbuseIPDB abuse confidence 33/100 from 12 report(s), last reported 5d ago. Interpreted as Suspicious.
- VirusTotal: 1/89 vendor(s) flagged malicious, 0 suspicious. Interpreted as Weak Reputation.
...
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** 140.82.113.3
- **Domain(s):** github.com
- **First/last seen:** 02:39:52 – 02:39:52 (1 occurrence(s))
- **Detection rule(s):** None (TI-only)

**Why this matters:** 172.16.1.66 queried github.com 1 time(s). Threat-intelligence assessment: CLEAN, MALICIOUS, WEAK_REPUTATION. Risk score 30/100 (Reputation 30, Behavior 0, Payload 0, Network context 0, Asset context 0 — asset role unknown).

**Threat intelligence:**
- AbuseIPDB abuse confidence 0/100 from 1 report(s), last reported 41d ago. Interpreted as Weak Reputation.
...
- **Severity:** Low &nbsp;|&nbsp; **Confidence:** Low &nbsp;|&nbsp; **Risk score:** 30/100
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** 185.199.110.133
- **Domain(s):** objects.githubusercontent.com
- **First/last seen:** 02:39:53 – 02:39:53 (1 occurrence(s))
- **Detection rule(s):** None (TI-only)

**Why this matters:** 172.16.1.66 queried objects.githubusercontent.com 1 time(s). Threat-intelligence assessment: CLEAN, MALICIOUS, SUSPICIOUS. Risk score 30/100 (Reputation 30, Behavior 0, Payload 0, Network context 0, Asset context 0 — asset role unknown).

**Threat intelligence:**
- AbuseIPDB abuse confidence 26/100 from 9 report(s), last reported 4d ago. Interpreted as Suspicious.
- VirusTotal: 0/89 vendor(s) flagged malicious, 0 suspicious. Interpreted as Clean.
- VirusTotal: 0/89 vendor(s) flagged malicious, 0 suspicious. Interpreted as Clean.
...
- **Severity:** Low &nbsp;|&nbsp; **Confidence:** Medium &nbsp;|&nbsp; **Risk score:** 22/100
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** 172.16.1.4
- **Domain(s):** wiresharkworkshop.online
- **First/last seen:** 02:38:49 – 02:38:49 (1 occurrence(s))
- **Detection rule(s):** DNS-003, DNS-007

**Why this matters:** 172.16.1.66 queried wiresharkworkshop.online 1 time(s). Local detection rule(s) DNS-003, DNS-007 fired for this activity. Threat-intelligence assessment: WEAK_REPUTATION. Risk score 22/100 (Reputation 6, Behavior 16, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **Destinations:** .
- **Domain(s):** wiresharkworkshop.online
- **First/last seen:** 02:38:53 – 02:38:53 (1 occurrence(s))
- **Detection rule(s):** DNS-003, DNS-007
...
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** N/A
- **Domain(s):** wpad.wiresharkworkshop.online
- **First/last seen:** 02:38:49 – 02:44:23 (8 occurrence(s))
- **Detection rule(s):** DNS-001, DNS-002

**Why this matters:** 172.16.1.66 queried wpad.wiresharkworkshop.online 8 time(s). Local detection rule(s) DNS-001, DNS-002 fired for this activity. Threat-intelligence assessment: CLEAN. Risk score 16/100 (Reputation 0, Behavior 16, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **Severity:** Informational &nbsp;|&nbsp; **Confidence:** Low &nbsp;|&nbsp; **Risk score:** 12/100
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** N/A
- **Domain(s):** desktop-skbr25f.local
- **First/last seen:** 02:38:48 – 02:38:48 (1 occurrence(s))
- **Detection rule(s):** DNS-003

**Why this matters:** 172.16.1.66 queried desktop-skbr25f.local 1 time(s). Local detection rule(s) DNS-003 fired for this activity. Risk score 12/100 (Reputation 0, Behavior 12, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** N/A
- **Domain(s):** desktop-skbr25f.wiresharkworkshop.online
- **First/last seen:** 02:38:53 – 02:38:53 (1 occurrence(s))
- **Detection rule(s):** DNS-003

**Why this matters:** 172.16.1.66 queried desktop-skbr25f.wiresharkworkshop.online 1 time(s). Local detection rule(s) DNS-003 fired for this activity. Risk score 12/100 (Reputation 0, Behavior 12, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** 172.16.1.4
- **Domain(s):** wireshark-ws-dc.wiresharkworkshop.online
- **First/last seen:** 02:38:48 – 02:38:49 (2 occurrence(s))
- **Detection rule(s):** DNS-003

**Why this matters:** 172.16.1.66 queried wireshark-ws-dc.wiresharkworkshop.online 2 time(s). Local detection rule(s) DNS-003 fired for this activity. Threat-intelligence assessment: CLEAN. Risk score 11/100 (Reputation 0, Behavior 11, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** N/A
- **Domain(s):** autodiscover.wiresharkworkshop.online
- **First/last seen:** 02:42:15 – 02:42:15 (1 occurrence(s))
- **Detection rule(s):** DNS-003

**Why this matters:** 172.16.1.66 queried autodiscover.wiresharkworkshop.online 1 time(s). Local detection rule(s) DNS-003 fired for this activity. Threat-intelligence assessment: CLEAN. Risk score 9/100 (Reputation 0, Behavior 9, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **First/last seen:** 02:44:17 – 02:44:17 (2 occurrence(s))
- **Detection rule(s):** DNS-003

**Why this matters:** 172.16.1.66 queried img-s-msn-com.akamaized.net 1 time(s). Local detection rule(s) DNS-003 fired for this activity. Threat-intelligence assessment: CLEAN. Risk score 9/100 (Reputation 0, Behavior 9, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** outlook.office365.com.
- **Domain(s):** autodiscover-s.outlook.com
- **First/last seen:** 02:42:13 – 02:42:13 (1 occurrence(s))
- **Detection rule(s):** DNS-003

**Why this matters:** 172.16.1.66 queried autodiscover-s.outlook.com 1 time(s). Local detection rule(s) DNS-003 fired for this activity. Threat-intelligence assessment: CLEAN. Risk score 7/100 (Reputation 0, Behavior 7, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
- **Affected endpoint(s):** 172.16.1.66 (asset role: Unknown)
- **Destinations:** N/A
- **Domain(s):** _kerberos._tcp.default-first-site-name._sites.dc._msdcs.wiresharkworkshop.online
- **First/last seen:** 02:38:53 – 02:38:53 (1 occurrence(s))
- **Detection rule(s):** DNS-003

**Why this matters:** 172.16.1.66 queried _kerberos._tcp.default-first-site-name._sites.dc._msdcs.wiresharkworkshop.online 1 time(s). Local detection rule(s) DNS-003 fired for this activity. Risk score 6/100 (Reputation 0, Behavior 6, Payload 0, Network context 0, Asset context 0 — asset role unknown).
...
Raw observations: 176 DNS record(s), 4 HTTP record(s), 0 file transfer(s) — aggregated below into 56 DNS behavioral event(s), 2 HTTP behavioral event(s) and 0 distinct file behavioral event(s).
...
| wiresharkworkshop.online | domain | suspicious | 29 | DNS-003, DNS-007 | VirusTotal:WEAK_REPUTATION |
| github.com | domain | suspicious | 28 | - | URLhaus:MALICIOUS, VirusTotal:CLEAN |
| objects.githubusercontent.com | domain | suspicious | 28 | - | URLhaus:MALICIOUS, VirusTotal:CLEAN |
...
|---|---|---|---|---|
| 13.107.42.16 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 426d ago. Interpreted as Clean. |
...
| 13.107.5.93 | AbuseIPDB | WEAK_REPUTATION | Low | AbuseIPDB abuse confidence 3/100 from 14 report(s), last reported 17d ago. Interpreted as Weak Reputation. |
...
| 13.69.239.79 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 99d ago. Interpreted as Clean. |
...
| 140.82.113.3 | AbuseIPDB | WEAK_REPUTATION | Low | AbuseIPDB abuse confidence 0/100 from 1 report(s), last reported 41d ago. Interpreted as Weak Reputation. |
...
| 141.98.10.79 | AbuseIPDB | SUSPICIOUS | Medium | AbuseIPDB abuse confidence 60/100 from 298 report(s), last reported 17d ago. Interpreted as Suspicious. |
...
| 185.199.110.133 | AbuseIPDB | SUSPICIOUS | Medium | AbuseIPDB abuse confidence 26/100 from 9 report(s), last reported 4d ago. Interpreted as Suspicious. |
...
| 199.232.196.209 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 445d ago. Interpreted as Clean. |
...
| 20.166.2.191 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 785d ago. Interpreted as Clean. |
...
| 20.189.173.10 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 118d ago. Interpreted as Clean. |
...
| 20.189.173.16 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 114d ago. Interpreted as Clean. |
...
| 20.189.173.26 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 113d ago. Interpreted as Clean. |
...
| 20.241.44.114 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 415d ago. Interpreted as Clean. |
...
| 20.7.1.246 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 497d ago. Interpreted as Clean. |
...
| 20.7.2.167 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 536d ago. Interpreted as Clean. |
...
| 208.95.112.1 | AbuseIPDB | SUSPICIOUS | Medium | AbuseIPDB abuse confidence 33/100 from 12 report(s), last reported 5d ago. Interpreted as Suspicious. |
...
| 40.126.29.14 | AbuseIPDB | WEAK_REPUTATION | Low | AbuseIPDB abuse confidence 13/100 from 88 report(s), last reported 17d ago. Interpreted as Weak Reputation. |
...
| 52.109.0.142 | AbuseIPDB | WEAK_REPUTATION | Low | AbuseIPDB abuse confidence 0/100 from 3 report(s), last reported 33d ago. Interpreted as Weak Reputation. |
...
| 52.109.0.91 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 510d ago. Interpreted as Clean. |
...
| 52.109.20.47 | AbuseIPDB | WEAK_REPUTATION | Low | AbuseIPDB abuse confidence 22/100 from 18 report(s), last reported 1d ago. Interpreted as Weak Reputation. |
...
| 52.109.6.53 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 515d ago. Interpreted as Clean. |
...
| 52.113.194.132 | AbuseIPDB | WEAK_REPUTATION | Low | AbuseIPDB abuse confidence 0/100 from 2 report(s), last reported 50d ago. Interpreted as Weak Reputation. |
...
| 52.191.219.104 | AbuseIPDB | CLEAN | High | AbuseIPDB abuse confidence 0/100 from 0 report(s), last reported 139d ago. Interpreted as Clean. |
